...
type: "command"
tags: ["planning", "feature", "specs", "implementation", "design"]
...
usage_examples:
  ...
  - "/feature Create admin dashboard for metrics"
---
...
- Create the plan in the `.agents/_specs/*.md` file. Name it appropriately based on the `Feature`.
...
- Project documentation (`docs/`, `references/`, etc.) for any relevant context files to help you draft the plan.
